...
const STATUS_PAGE = IS_PRODUCTION
  ? 'https://tx-status-app.safe.protofire.io/?serviceUrl=https://gateway.safe.etherlink.com'
  : 'https://tx-status-app.safe.protofire.io/?serviceUrl=https://gateway.staging.safe.etherlink.com'
