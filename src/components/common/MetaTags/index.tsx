...
const descriptionText =
  'Etherlink Safe (prev. Gnosis Safe) is the most trusted platform to manage digital assets on Ethereum and multiple EVMs. Over $40B secured.'
const titleText = 'Etherlink Safe'
...
const MetaTags = ({ prefetchUrl }: { prefetchUrl: string }) => (
  <>
    ...
    <meta name="twitter:site" content="@etherlink" />
