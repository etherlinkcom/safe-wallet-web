...
export const ImportFileUpload = ({
  ...
  return (
    <>
      <Typography>Import Etherlink Safe data by uploading a file in the area below.</Typography>
      ...
      <Typography>
        ...
        />
        Only JSON files exported from the Etherlink Safe can be imported.
      </Typography>
    </>
  )
}
