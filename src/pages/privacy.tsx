...
const SafePrivacyPolicy = () => (
  <SmoothScroll>
    ...
    <ol>
      ...
      <li>
        &ldquo;Etherlink Safe&rdquo; refers to a web-based graphical user interface for Safe Accounts as well as a
    ...
    <h4>4.1. When visiting our website and using Etherlink Safe</h4>
    <p>
      When visiting our website or using Etherlink Safe, we may collect and process personal data. The data will be
    ...
    <ol start={4}>
      <li>
        ...
        the Etherlink Safe, we process your
        <ol>
    ...
    <p>
      Etherlink Safe mobile apps are distributed via{' '}
